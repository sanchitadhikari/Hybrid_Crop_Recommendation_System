...
Download `Crop_recommendation.csv` from [Kaggle](https://www.kaggle.com/datasets/atharvaingle/crop-recommendation-dataset) and place it in the `data/` folder.
...
The API will be live at **http://127.0.0.1:8081**

Interactive API docs available at **http://127.0.0.1:8081/docs**

### Option B — Run the Google Colab Notebook

1. Open [colab.research.google.com](https://colab.research.google.com)
2. Upload `notebooks/Hybrid_Crop_Recommendation_System.ipynb`
3. Run **Cell 1** to install packages
4. Upload your CSV when prompted in **Cell 3**
5. Run all cells in order — every step is labelled

### Option C — Train Models from Script
...
# Output: 🌾 RECOMMENDED CROP: RICE  |  Confidence: 98.2%
```
...
```json
{
  ...
  "uncertainty": 0.0198,
  "top_3": [
    {"crop": "rice",       "probability": 98.2},
    {"crop": "jute",       "probability": 0.5},
    {"crop": "pigeonpeas", "probability": 0.1}
  ]
}
```
